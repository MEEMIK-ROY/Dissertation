...
\begin{document}
    ...
    \subsubsection{Deconvolution of Glow Curves}
        ...
        \FloatBarrier\begin{multicols}{2}
            \begin{Figure}
                \centering
                \includegraphics[width=0.6\linewidth]{deconvPU50.png}
                \captionof{figure}{Deconvolution of glow curve of pure $Li_2SiO_3$ at 50 Gy}\label{fig:deconvPU50}
            \end{Figure}
            \begin{Figure}
                \centering
                \includegraphics[width=0.6\linewidth]{deconvPU100.png}
                \captionof{figure}{Deconvolution of glow curve of pure $Li_2SiO_3$ at 100 Gy}\label{fig:deconvPU100}
            \end{Figure}
        \end{multicols}
        ...
        \FloatBarrier\begin{multicols}{2}
            \begin{Figure}
                \centering
                \includegraphics[width=0.6\linewidth]{deconvER50.png}
                \captionof{figure}{Deconvolution of glow curve of $Li_2SiO_3$ doped with Erbium at 50 Gy}\label{fig:deconvER50}
            \end{Figure}
            \begin{Figure}
                \centering
                \includegraphics[width=0.6\linewidth]{deconvER100.png}
                \captionof{figure}{Deconvolution of glow curve of $Li_2SiO_3$ doped with Erbium at 100 Gy}\label{fig:deconvER100}
            \end{Figure}
        \end{multicols}
\end{document}