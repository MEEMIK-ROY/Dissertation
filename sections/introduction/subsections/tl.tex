...
\begin{document}
    ...
    \begin{Figure}
        ...
        \captionof{figure}{A thermoluminescent dosimeter\cite{u6}}\label{fig:Dosimeter}
    \end{Figure}
    ...
    \subsubsection*{\large Thermoluminescence}
        ...
        \begin{Figure}
            ...
            simple two-level model.\cite{a6}}\label{fig:BandDiagram}
        \end{Figure}
    ...
    \subsubsection*{\large Process of Thermoluminescence Dosimetry}
        ...
        \begin{Figure}
            \centering
            \includegraphics[width=0.8\linewidth]{TLDTheory.png}
            \captionof{figure}{Theory of operation behind thermoluminescent dosimeters\cite{u8}}\label{fig:TLDTheory}
        \end{Figure}
